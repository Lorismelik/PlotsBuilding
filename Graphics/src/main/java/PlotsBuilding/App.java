...
public class App extends JFrame {
    ...
    public App () {
        ...
        Window.setTitle("Приветствие");
        Window.setSize(323, 200);
        Count = new TextField("", 40); 
        Count.setLocation(97, 90);
        Count.setSize(90, 20);    
        JLabel co = new JLabel("Введите количество изначальных функций:");
        JLabel Hello = new JLabel("Здраствуйте, вас приветствует Графикатор-3000");
        Hello.setLocation(13, 20);
        Hello.setSize(300, 20);
        co.setLocation(27, 55);
        co.setSize(300, 20);
